        ...
        if (!$stmt) {
            ...
            if (!$result || mysqli_num_rows($result) === 0) {
                ...
                if ($user["status"] !== "active") {
                    ...
                    // دعم كل من كلمة السر المشفرة والمباشرة
                    ...
                    if (!$password_valid) {
                        ...
                        $login_sql = "INSERT INTO login_sessions (user_id, login_time, ip_address) VALUES (?, NOW(), ?)";
...
<div class="container">
    <div class="left">
        ...
        <form method="POST" id="loginForm">
            ...
            <input id="email" name="email" type="email" placeholder="Enter your email" value="<?= htmlspecialchars($email) ?>" required autocomplete="email">

            <label for="password">Password</label>
            <input id="password" name="password" type="password" placeholder="Enter your password" required minlength="8" autocomplete="current-password">
        ...
        <div class="social-icons">
            <a href="https://accounts.google.com" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-google"></i></a>
            <a href="https://www.facebook.com/login/" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-facebook-f"></i></a>
