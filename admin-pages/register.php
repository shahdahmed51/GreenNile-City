...
// ========================================
// TEMP DEBUG: إظهار أخطاء MySQL الحقيقية
// شيل السطر ده بعد ما تحل المشكلة
// ========================================
        ...
        if (!$check_stmt) {
            ...
            if (
                ...
                try {
                    ...
                    // ========================================
                    // TEMP DEBUG: بيظهر رسالة الخطأ الحقيقية
                    // شيل السطر ده بعد ما تحل المشكلة وارجع
                    // للرسالة العامة تحت
                    // ========================================
                    $error =
                        "Registration failed: " . $e->getMessage();

                    // الرسالة الأصلية (فعّلها تاني بعد التشخيص):
...
<div class="register-container">
    ...
    <div class="register-card">
        ...
        >
            ...
            <!-- ROLE (fixed to resident - admin accounts are created separately, not via public signup) -->
